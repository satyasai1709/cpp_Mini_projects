...
int main()
{
    ...
    while(player1<100 && player2<100)
    {
        ...
        if(player1<lastposition)
            cout<<"\n\aOops!! SNAKE FOUND!! YOU ARE AT POSITION "<<player1<<endl;
        ...
        if(player2<lastposition)
            cout<<"\n\aOops!! SNAKE FOUND!! YOU ARE AT POSITION "<<player2<<endl;
    ...
    draw_line(50,'+');
    cout<<endl;
    gamescore(player1name,player1name,player1,player2);
    cout<<"\n\n\n";
    if(player1>=player2)
...
void play_dice(int &score)
{
    ...
    {
        score -=dice;
        cout<<"You cant move any further than 100"<<endl;
    }
